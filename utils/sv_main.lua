lib.versionCheck('https://github.com/paradoxtended/paradox_bridge')
...
function Utils.logToDiscord(source, xPlayer, message, webhook)
    if webhook == 'WEBHOOK_HERE' then return end
...
lib.callback.register('paradox_bridge:getItemLabels', function()
